...
export default function DebitNotesPage() {
  ...
  async function reload() {
    setLoading(true);
    try {
      const data = await api.listInvoices("DEBIT_NOTE");
      setRows(data || []);
    } catch (err) {
      console.error(err);
    } finally {
  ...
  return (
    <PageShell>
      <PageHeader 
        title="Debit Notes / إشعارات مدينة" 
        description="Manage and issue supplemental debit notes for dynamic adjustments"
      />
